var fun = [{
    "type": "record",
    "name": "com.xyz.ds.fun.Key", 
    "fields": [
        { "name": "figi", "type": "com.xyz.Figi" }
    ]
}, {
    "type": "record",
    "name": "com.xyz.ds.fun.Contact",
    "fields": [
    ...
    "type": "record",
    "name": "com.xyz.ds.fun.NewPricingSource",
    "fields": [
    ...
    "type": "record",
    "name": "com.xyz.ds.fun.ExistingPricingSource",
    "fields": [
    ]
}, {
    "type": "record",
    "name": "com.xyz.ds.fun.PricingInfo",
    "fields": [
        { "name": "xyzPricingContact", "type": [ "null","string"],"doc": "Your contact on xyz's Data Team" },
        { "name": "isThisANewPricingSource", "type": [ "com.xyz.Default","com.xyz.ds.fun.NewPricingSource","com.xyz.ds.fun.ExistingPricingSource"],"doc": "Is this a new pricing source?" }
    ]
}, {
    "type": "record",
    "name": "com.xyz.ds.fun.GeneralInformation",
    "fields": [
        { "name": "documentContact", "type": "com.xyz.ds.fun.Contact","doc": "Contact for specified type of fund data - Documents" },
        { "name": "pricingAndAssetsContact", "type": "com.xyz.ds.fun.Contact","doc": "Contact for specified type of fund data - Pricing and Assets" },
        { "name": "dividendsContact", "type": [ "null","com.xyz.ds.fun.Contact"],"doc": "Contact for specified type of fund data - Dividends" },
        { "name": "portfolioHoldingsContact", "type": "com.xyz.ds.fun.Contact","doc": "Contact for specified type of fund data - Portfolio Holdings" },
        { "name": "pricingInfo", "type": "com.xyz.ds.fun.PricingInfo","doc": "" }
    ]
}, {
    "type": "record",
    "name": "com.xyz.ds.fun.ExistingFund",
    "fields": [
        { "name": "existingFigiOrTicker", "type": "string","doc": "What is the existing FIGI identifier or ticker id for that share class?" }
    ]
}, {
    "type": "record",
    "name": "com.xyz.ds.fun.NoExistingFund",
    "fields": [
    ]
}, {
    "name": "com.xyz.ds.fun.OpenSubType",
    "type": "enum",
    "symbols": ["DEFAULT","FUND_OF_FUNDS","SICAV","UNIT_TRUST","FCP","OPEN_END_FUND","OEIC","OPEN_END_PENSION"]
}, {
    "type": "record",
    "name": "com.xyz.ds.fun.OpenEndFund",
    "fields": [
        { "name": "subType", "type": "com.xyz.ds.fun.OpenSubType","doc": "The sub-type of fund being submitted" }
    ]
}, {
    "name": "com.xyz.ds.fun.ClosedSubType",
    "type": "enum",
    "symbols": ["DEFAULT","SICAF","TRUST_UNITS","INVESTMENT_TRUST","CLOSED_END_FUND","CLOSED_END_PENSION"]
}, {
    "type": "record",
    "name": "com.xyz.ds.fun.ClosedEndFund",
    "fields": [
        { "name": "subType", "type": "com.xyz.ds.fun.ClosedSubType","doc": "The sub-type of fund being submitted" }
    ]
}, {
    "name": "com.xyz.ds.fun.HedgeSubType",
    "type": "enum",
    "symbols": ["DEFAULT","HEDGE_FUND","FUND_OF_HEDGE_FUNDS"]
}, {
    "name": "com.xyz.ds.fun.FiscalMonth",
    "type": "enum",
    "symbols": ["DEFAULT","JANUARY","FEBRUARY","MARCH","APRIL","MAY","JUNE","JULY","AUGUST","SEPTEMBER","OCTOBER","NOVEMBER","DECEMBER"]
}, {
    "type": "record",
    "name": "com.xyz.ds.fun.HedgeFund",
    "fields": [
        { "name": "subType", "type": "com.xyz.ds.fun.HedgeSubType","doc": "The sub-type of the fund being submitted" },
        { "name": "fiscalMonth", "type": "com.xyz.ds.fun.FiscalMonth","doc": "This month signifies the end of the year for the Fund" },
    ...
    "type": "record",
    "name": "com.xyz.ds.fun.FundInformation",
    "fields": [
        ...
        { "name": "isThereAnExistingShareClass", "type": [ "com.xyz.Default","com.xyz.ds.fun.ExistingFund","com.xyz.ds.fun.NoExistingFund"],"doc": "Is there an existing share class with a registered FIGI?" },
        ...
        { "name": "fundType", "type": [ "com.xyz.Default","com.xyz.ds.fun.OpenEndFund","com.xyz.ds.fun.ClosedEndFund","com.xyz.ds.fun.HedgeFund"],"doc": "The type of the fund being submitted" }
    ]
}, {
    "type": "record",
    "name": "com.xyz.ds.fun.CompanyInformation",
    "fields": [
    ...
    "name": "com.xyz.ds.fun.PortfolioFrequency",
    "type": "enum",
    "symbols": ["DEFAULT","ANNUAL","MONTHLY","QUARTERLY"]
}, {
    "name": "com.xyz.ds.fun.ManagerTitle",
    "type": "enum",
    "symbols": ["DEFAULT","FUND_MANAGER","LEAD_MANAGER","CO_MANAGER","TEAM_MEMBER"]
}, {
    "type": "record",
    "name": "com.xyz.ds.fun.Manager",
    "fields": [
        { "name": "portfolioManagerTitle", "type": "com.xyz.ds.fun.ManagerTitle","doc": "Indicates the title of the managing member" },
    ...
    "type": "record",
    "name": "com.xyz.ds.fun.ClosedEndShareClass",
    "fields": [
    ]
}, {
    "name": "com.xyz.ds.fun.HedgeFrequency",
    "type": "enum",
    "symbols": ["DEFAULT","DAILY","MONTHLY","QUARTERLY","SEMI_ANNUAL","ANNUAL","WEEKLY","SEMI_MONTHLY"]
}, {
    "name": "com.xyz.ds.fun.HedgeSchedule",
    "type": "enum",
    "symbols": ["DEFAULT","DAYS","MONTHS","YEARS"]
}, {
    "type": "record",
    "name": "com.xyz.ds.fun.HedgeShareClass",
    "fields": [
        { "name": "doYouWantToRequestATicker", "type": [ "null","boolean"],"doc": "Would you like to request a ticker?" },
        { "name": "requestedTicker", "type": [ "null","string"],"doc": "Ticker that is being requested" },
        { "name": "minimumInvestment", "type": [ "null","double"],"doc": "The least amount needed to open an account" },
        ...
        { "name": "subscriptionFrequency", "type": "com.xyz.ds.fun.HedgeFrequency","doc": "Stated periods that the fund will allow subscriptions" },
        { "name": "redemptionFrequency", "type": "com.xyz.ds.fun.HedgeFrequency","doc": "Stated periods that the fund will allow redemptions" },
        ...
        { "name": "lockUpType", "type": "com.xyz.ds.fun.HedgeSchedule","doc": "This is the designated period of time that the fund prohibits redemptions after the shareholders initial investment.  The lockup period may be expressed in days, months, or years" },
        { "name": "performanceFeeFrequency", "type": "com.xyz.ds.fun.HedgeFrequency","doc": "Interval at which a fund charges its performance fee" }
    ]
}, {
    "type": "record",
    "name": "com.xyz.ds.fun.ShareClass",
    "fields": [
        ...
        { "name": "investorShareClass", "type": "com.xyz.ds.fun.InvestorShareClass","doc": "Identifies the type of investor that will be allowed to invest in the fund" },
        { "name": "paymentShareClass", "type": "com.xyz.ds.fun.PaymentShareClass","doc": "Identifies how distributions are treated by a fund" },
        { "name": "valuationFrequency", "type": "com.xyz.ds.fun.ValuationFrequency","doc": "The frequency of valuation" },
        { "name": "dividendFrequency", "type": [ "null","com.xyz.ds.fun.DividendFrequency"],"doc": "The frequency of distrubutions" },
        ...
        { "name": "securityIdentifier", "type": { "type": "array", "items": "com.xyz.ds.fun.SecurityIdentifier"},"doc": "" },
        { "name": "shareClassType", "type": [ "com.xyz.Default","com.xyz.ds.fun.OpenEndShareClass","com.xyz.ds.fun.ClosedEndShareClass","com.xyz.ds.fun.HedgeShareClass"],"doc": "The type of the fund being submitted" }
    ]
}, {
    "name": "com.xyz.ds.fun.StatusEnum",
    "type": "enum",
    "symbols": ["DEFAULT","STAGED","NOT_PROCESSED","ACCEPT","REJECT","DUPLICATE"]
}, {
    "name": "com.xyz.ds.fun.AttachmentStatusEnum",
    "type": "enum",
    "symbols": ["DEFAULT","NO_UPLOAD","UPLOAD_PENDING","UPLOAD_COMPLETED"]
}, {
    "type": "record",
    "name": "com.xyz.ds.fun.AuditRecord",
    "fields": [
        ...
        { "name": "status", "type": "com.xyz.ds.fun.StatusEnum","doc": "The status of the application, as determined internally.","default": "NOT_PROCESSED" },
        { "name": "attachmentStatus", "type": "com.xyz.ds.fun.AttachmentStatusEnum","doc": "The status of the attachments for this submission.","default": "NO_UPLOAD" },
    ...
    "type": "record",
    "name": "com.xyz.ds.fun.Data",
    "fields": [
        { "name": "generalInformation", "type": "com.xyz.ds.fun.GeneralInformation" },
        { "name": "fundInformation", "type": "com.xyz.ds.fun.FundInformation" },
        { "name": "companyInformation", "type": "com.xyz.ds.fun.CompanyInformation","doc": "The Management Company, or the Investment Company (If this is a Hedge Fund)" },
        { "name": "portfolioManagement", "type": "com.xyz.ds.fun.PortfolioManagement" },
        { "name": "shareClass", "type": "com.xyz.ds.fun.ShareClass" },
        { "name": "auditField", "type": "com.xyz.ds.fun.AuditRecord","internal": "true" }
    ]
}, {
    "type": "record",
    "name": "com.xyz.ds.fun",
    "fields": [
        { "name": "key", "type": "com.xyz.ds.fun.Key" },
        { "name": "data", "type": "com.xyz.ds.fun.Data" },
